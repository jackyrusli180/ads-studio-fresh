...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initially hide all sections except Platform Selection
    ...
    // Hide all sections initially except platform selection
    hideAllSections();
    ...
    // Function to update platform account sections
    function updatePlatformAccountSectionsLocal() {
        console.log('Updating platform account sections...');
        ...
        console.log('Meta selected:', metaSelected);
        console.log('TikTok selected:', tiktokSelected);
        
        // Show/hide Meta account section
        const metaAccountSection = document.getElementById('metaAccountSection');
        const metaCampaignSection = document.getElementById('metaCampaignSection');
        const metaAdsetSection = document.getElementById('metaAdsetSection');
        
        if (metaAccountSection) {
            metaAccountSection.style.display = metaSelected ? 'block' : 'none';
        }
        
        if (metaCampaignSection) {
            metaCampaignSection.style.display = 'none';
        }
        
        if (metaAdsetSection) {
            metaAdsetSection.style.display = 'none';
        }
        
        // Show/hide TikTok account section
        const tiktokAccountSection = document.getElementById('tiktokAccountSection');
        const tiktokCampaignSection = document.getElementById('tiktokCampaignSection');
        const tiktokAdgroupSection = document.getElementById('tiktokAdgroupSection');
        
        if (tiktokAccountSection) {
            tiktokAccountSection.style.display = tiktokSelected ? 'block' : 'none';
        }
        
        if (tiktokCampaignSection) {
            tiktokCampaignSection.style.display = 'none';
        }
        
        if (tiktokAdgroupSection) {
            tiktokAdgroupSection.style.display = 'none';
        }
    }
    
    // Call this function on page load to set initial state
    updatePlatformAccountSectionsLocal();
    ...
    function updateFormSections() {
        ...
        if (platformsSelected) {
            ...
            if (templateSelected) {
                ...
                // Show dynamic fields based on operation type (always 3 now)
                ...
                // Show adgroups section if we have assets
        ...
        // Update platform account sections
        updatePlatformAccountSectionsLocal();
    }
    
    // Initialize form sections based on any pre-selected values
    updateFormSections();
    ...
    function updateDynamicFields(operation) {
        // Always use operation type 3 (Create new Campaign, Adset & Ads)
        let fields = '';
