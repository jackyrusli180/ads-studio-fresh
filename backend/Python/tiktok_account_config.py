...
This file contains the mapping between TikTok advertiser accounts and their associated IDs
...
# Function to get account details by advertiser_id
def get_account_details(advertiser_id):
    """
...
# Function to get all account names and IDs for dropdown selection
